...
namespace Fish.MovieManager.testUI.Content
{
	...
	{
		private const string FontSmall = "大号";
		private const string FontLarge = "小号";
		...
		public SettingsAppearanceViewModel()
		{
			...
			this.themes.Add(new Link { DisplayName = "黑色", Source = AppearanceManager.DarkThemeSource });
			this.themes.Add(new Link { DisplayName = "白色", Source = AppearanceManager.LightThemeSource });
